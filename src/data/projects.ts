...
export const projects: Project[] = [
  ...
  {
    id: 'weapon-threat-detection',
    number: '03',
    title: 'Weapon Threat Detection Console',
    shortDescription:
      'Professional AI surveillance dashboard focused on real-time threat monitoring, object detection visualization, security analytics, event management, and operational awareness workflows.',
    fullDescription:
      'Real-time AI-powered threat detection console for surveillance environments. Interactive monitoring dashboard with object detection workflows, threat assessment visualization, event tracking, and security-focused analytics. The interface supports live threat monitoring, detection overlays, operational event logs, and security analytics designed for surveillance and security operations teams.',
    category: 'Computer Vision / Security AI',
    filterCategories: ['cv', 'dashboards'],
    tags: ['React', 'TypeScript', 'FastAPI', 'YOLOv8'],
    featured: true,
    image: '/assets/projects/weapons.webp',
    liveDemo: 'https://weapon-threat-detection-console.vercel.app/',
    github: 'https://github.com/sidnei-almeida/weapon-threat-detection-console',
  },
  {
    id: 'pm-monitor',
    number: '04',
