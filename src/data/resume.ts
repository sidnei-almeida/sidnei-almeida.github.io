      ...
      engagements: [
        {
          ...
          achievements: [
            ...
            'Runs production infrastructure: a containerised Docker Compose stack on a self-managed VPS behind nginx, with connection pooling and Prometheus/Grafana observability',
          ],
        },
      ],
    },
