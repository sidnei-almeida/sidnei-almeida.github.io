...
export function StatCard({ value, label, icon: Icon }: StatCardProps) {
  return (
    <div className="stat-card carbon-fiber-surface group flex flex-col gap-2.5 border border-line bg-panel p-4 transition-colors duration-300 hover:border-accent/35">
