...
async function preloadExampleFiles() {
  const examplePaths = [
    { emotion: 'angry', path: './image_emotion_class/angry.jpg' },
    { emotion: 'disgust', path: './image_emotion_class/disgust.jpg' },
    { emotion: 'fear', path: './image_emotion_class/fear.jpg' },
    { emotion: 'happy', path: './image_emotion_class/happy.jpg' },
    { emotion: 'neutral', path: './image_emotion_class/neutral.jpg' },
    { emotion: 'sad', path: './image_emotion_class/sad.jpg' },
    { emotion: 'surprised', path: './image_emotion_class/surprised.jpg' }
  ];
